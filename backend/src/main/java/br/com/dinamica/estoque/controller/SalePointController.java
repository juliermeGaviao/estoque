...
public class SalePointController {
	...
	private static final String ENTITY = "Ponto de venda";
	private static final String ENTITIES = "Pontos de venda";
	private static final String NOT_FOUND = ENTITY + " não encontrado: ";

	private SalePointService service;

	public SalePointController(SalePointService service) {
	...
	public ResponseEntity<Object> list(
		...
		try {
			...
			Page<SalePointDto> result = this.service.list(nome, pageable);
	...
	@PostMapping
	public ResponseEntity<Object> save(@RequestBody SalePointDto dto, @AuthenticationPrincipal Usuario usuario) {
		try {
	...
	public ResponseEntity<Object> save(@RequestBody List<SalePointDto> dtos, @AuthenticationPrincipal Usuario usuario) {
		try {
