...
public class ProviderContactController {
	...
	private static final String ENTITY = "Contato de fornecedor";
	private static final String ENTITIES = "Contatos de fornecedor";
	private static final String NOT_FOUND = ENTITY + " não encontrado: ";

	private ProviderContactService service;

	public ProviderContactController(ProviderContactService service) {
	...
	public ResponseEntity<Object> list(
		...
		try {
			...
			Page<ProviderContactDto> result = this.service.list(idFornecedor, pageable);
	...
	@PostMapping
	public ResponseEntity<Object> save(@RequestBody ProviderContactDto dto, @AuthenticationPrincipal Usuario usuario) {
		try {
