...
public class PersonClientController {
	...
	private static final String ENTITY = "Pessoa Cliente";
	private static final String ENTITIES = "Pessoas Clientes";
	private static final String NOT_FOUND = ENTITY + " não encontrado: ";

	private PersonClientService service;
	...
	@PostMapping
	public ResponseEntity<Object> save(@RequestBody PersonClientDto dto, @AuthenticationPrincipal Usuario usuario) {
		try {
