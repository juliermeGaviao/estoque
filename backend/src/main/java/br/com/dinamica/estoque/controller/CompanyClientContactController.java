...
@RestController
@RequestMapping("/company-client-contact")
@Slf4j
public class CompanyClientContactController {

	private static final String ENTITY = "Contato de Empresa Cliente";
	private static final String ENTITIES = "Contatos de empresa cliente";
	private static final String NOT_FOUND = ENTITY + " não encontrado: ";

	private CompanyClientContactService service;

	public CompanyClientContactController(CompanyClientContactService service) {
	...
	@PostMapping
	public ResponseEntity<Object> save(@RequestBody CompanyClientContactDto dto, @AuthenticationPrincipal Usuario usuario) {
		try {
