...
public class ProductController {
	...
	private static final String ENTITY = "Produto";
	private static final String ENTITIES = "Produtos";
	...
	@PostMapping
	public ResponseEntity<Object> save(@RequestBody ProductDto dto, @AuthenticationPrincipal Usuario usuario) {
		try {
