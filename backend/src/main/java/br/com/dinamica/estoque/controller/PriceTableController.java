...
public class PriceTableController {
	...
	private static final String ENTITY = "Tabela de preços";
	private static final String ENTITIES = "Tabelas de preços";
	...
	public ResponseEntity<Object> list(
		...
		try {
			...
			Page<PriceTableDto> result = this.service.list(nome, pageable);
	...
	@PostMapping
	public ResponseEntity<Object> save(@RequestBody PriceTableDto dto, @AuthenticationPrincipal Usuario usuario) {
		try {
	...
	public ResponseEntity<Object> save(@RequestBody List<PriceTableDto> dtos, @AuthenticationPrincipal Usuario usuario) {
		try {
