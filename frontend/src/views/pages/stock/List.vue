...
<template>
  ...
  <BlockUI :blocked="loading" fullScreen>
    ...
    <Dialog v-model:visible="visible" modal :closable="false" :header="action === 'visualizar' ? 'Visualizar Pedido de Compra' : 'Inserir Pedido de Compra'" style="width: 95%">
      ...
      <Form ref="purchaseOrderForm" :resolver="purchaseOrderFormValidator" :initialValues="purchaseOrderFormValues" @submit="savePurchaseOrder" class="grid flex flex-column gap-2">
        ...
        <FormField class="flex justify-end gap-2" v-show="action === 'criar'">
          ...
          <Button label="Salvar" icon="pi pi-save" :disabled="!products.length" type="submit" raised/>
        </FormField>
